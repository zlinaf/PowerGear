...
extern "C" void syr2k(DATA_TYPE alpha,DATA_TYPE beta,DATA_TYPE A_0[N*N/4], DATA_TYPE A_1[N*N/4], DATA_TYPE A_2[N*N/4], DATA_TYPE A_3[N*N/4], 
...
int main(int argc, char* argv[])
{
    ...
    for(inv = 0; inv < INV_NUM; inv++){
		...
		//==============================
		syr2k(alpha,beta,A_0, A_1, A_2, A_3, B_0, B_1, B_2, B_3, C_0, C_1, C_2, C_3, D_out_0, D_out_1, D_out_2, D_out_3);
