...
def gen_script(fw, src_dir, prj_name, kernel_name, iob, bp, lp1, lp2):
    ...
    fw.write('set_directive_resource -core RAM_1P "{}" D\n'.format(kernel_name))
    fw.write('set_directive_array_partition -type cyclic -factor {} -dim 2 "{}" D\n'.format(iob, kernel_name))
    fw.write('set_directive_interface -mode ap_fifo "{}" E_out\n'.format(kernel_name))
    fw.write('set_directive_array_partition -type cyclic -factor {} -dim 2 "{}" E_out\n'.format(iob, kernel_name))

    # buffer partition
    fw.write('set_directive_array_partition -type cyclic -factor {} -dim 2 "{}" buff_A\n'.format(iob, kernel_name))
    fw.write('set_directive_array_partition -type cyclic -factor {} -dim 2 "{}" buff_B\n'.format(iob, kernel_name))
    fw.write('set_directive_array_partition -type cyclic -factor {} -dim 2 "{}" buff_C\n'.format(iob, kernel_name))
    fw.write('set_directive_array_partition -type cyclic -factor {} -dim 2 "{}" buff_D\n'.format(iob, kernel_name))
    fw.write('set_directive_array_partition -type cyclic -factor {} -dim 2 "{}" buff_E_out\n'.format(iob, kernel_name))
    ...
    if bp == 'd1d2':
        ...
        fw.write('set_directive_array_partition -type cyclic -factor {} -dim 1 "{}" buff_B\n'.format(iob, kernel_name))
        fw.write('set_directive_array_partition -type cyclic -factor {} -dim 1 "{}" buff_C\n'.format(iob, kernel_name))
        fw.write('set_directive_array_partition -type cyclic -factor {} -dim 1 "{}" buff_D\n'.format(iob, kernel_name))
        fw.write('set_directive_array_partition -type cyclic -factor {} -dim 1 "{}" buff_E_out\n'.format(iob, kernel_name))
