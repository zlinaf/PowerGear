...
# set the hardware to RUNNING STATUS 
...
set_property OUTPUT_VALUE 1 [get_hw_probes probe_out_OBUF -of_objects [get_hw_vios -of_objects [get_hw_devices xczu9_0] -filter {CELL_NAME=~"vio_inst"}]]
