...
extern "C" void atax(DATA_TYPE A_0[M*N/8], DATA_TYPE A_1[M*N/8], DATA_TYPE A_2[M*N/8], DATA_TYPE A_3[M*N/8], 
	DATA_TYPE A_4[M*N/8], DATA_TYPE A_5[M*N/8], DATA_TYPE A_6[M*N/8], DATA_TYPE A_7[M*N/8], DATA_TYPE x[N], DATA_TYPE y_out[N]);
...
int main(int argc, char* argv[])
{
	...
	DATA_TYPE A_0[M*N/8], A_1[M*N/8], A_2[M*N/8], A_3[M*N/8], A_4[M*N/8], A_5[M*N/8], A_6[M*N/8], A_7[M*N/8];
	DATA_TYPE x[N];
	DATA_TYPE y_out[N];
    ...
    for(inv = 0; inv < INV_NUM; inv++){
		...
		int A_j_4 = 0, A_j_5 = 0, A_j_6 = 0, A_j_7 = 0;
		...
		//==============================
		atax(A_0, A_1, A_2, A_3, A_4, A_5, A_6, A_7, x, y_out);
