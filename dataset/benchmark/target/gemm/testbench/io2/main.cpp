...
extern "C" void gemm(DATA_TYPE alpha, DATA_TYPE beta, DATA_TYPE A_0[N*N/2], DATA_TYPE A_1[N*N/2], DATA_TYPE B_0[N*N/2], DATA_TYPE B_1[N*N/2], 
	DATA_TYPE C_0[N*N/2], DATA_TYPE C_1[N*N/2], DATA_TYPE D_out_0[N*N/2], DATA_TYPE D_out_1[N*N/2]);
...
int main(int argc, char* argv[])
{
    ...
    for(inv = 0; inv < INV_NUM; inv++){
		...
		//==============================
		gemm(alpha, beta, A_0, A_1, B_0, B_1, C_0, C_1, D_out_0, D_out_1);
