...
extern "C" void gemm(DATA_TYPE alpha, DATA_TYPE beta, DATA_TYPE A_0[N*N/8], DATA_TYPE A_1[N*N/8], DATA_TYPE A_2[N*N/8], DATA_TYPE A_3[N*N/8], 
...
int main(int argc, char* argv[])
{
    ...
    for(inv = 0; inv < INV_NUM; inv++){
		...
		//==============================
		gemm(alpha, beta, A_0, A_1, A_2, A_3, A_4, A_5, A_6, A_7, B_0, B_1, B_2, B_3, B_4, B_5, B_6, B_7, 
