...
extern "C" void syrk(DATA_TYPE alpha,DATA_TYPE beta,DATA_TYPE A_0[N*N/8], DATA_TYPE A_1[N*N/8], DATA_TYPE A_2[N*N/8], DATA_TYPE A_3[N*N/8], 
	...
	DATA_TYPE C_out_0[N*N/8], DATA_TYPE C_out_1[N*N/8], DATA_TYPE C_out_2[N*N/8], DATA_TYPE C_out_3[N*N/8],
	DATA_TYPE C_out_4[N*N/8], DATA_TYPE C_out_5[N*N/8], DATA_TYPE C_out_6[N*N/8], DATA_TYPE C_out_7[N*N/8]);
...
int main(int argc, char* argv[])
{
	...
	DATA_TYPE C_out_0[N*N/8], C_out_1[N*N/8], C_out_2[N*N/8], C_out_3[N*N/8], C_out_4[N*N/8], C_out_5[N*N/8], C_out_6[N*N/8], C_out_7[N*N/8];
    ...
    for(inv = 0; inv < INV_NUM; inv++){
		...
		//==============================
		syrk(alpha,beta,A_0, A_1, A_2, A_3, A_4, A_5, A_6, A_7, 
