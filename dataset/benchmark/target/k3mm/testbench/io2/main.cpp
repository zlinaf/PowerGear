...
extern "C" void k3mm(DATA_TYPE A_0[M*N/2], DATA_TYPE A_1[M*N/2], DATA_TYPE B_0[M*N/2], DATA_TYPE B_1[M*N/2], DATA_TYPE C_0[M*N/2], DATA_TYPE C_1[M*N/2], DATA_TYPE D_0[M*N/2], DATA_TYPE D_1[M*N/2], DATA_TYPE E_out_0[M*N/2], DATA_TYPE E_out_1[M*N/2]);
...
int main(int argc, char* argv[])
{
    ...
    for(inv = 0; inv < INV_NUM; inv++){
		...
		//==============================
		k3mm(A_0, A_1, B_0, B_1, C_0, C_1, D_0, D_1, E_out_0, E_out_1);
