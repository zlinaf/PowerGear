...
extern "C" void k2mm(DATA_TYPE alpha, DATA_TYPE beta, DATA_TYPE A_0[N*N/8], DATA_TYPE A_1[N*N/8], DATA_TYPE A_2[N*N/8], DATA_TYPE A_3[N*N/8], 
...
int main(int argc, char* argv[])
{
    ...
    for(inv = 0; inv < INV_NUM; inv++){
		...
		//==============================
		k2mm(alpha, beta, A_0, A_1, A_2, A_3, A_4, A_5, A_6, A_7, 
