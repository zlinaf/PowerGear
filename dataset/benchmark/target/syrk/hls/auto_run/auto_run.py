...
def gen_script(fw, src_dir, prj_name, kernel_name, iob, bp, lp1, lp2):
    ...
    fw.write('set_directive_interface -mode ap_fifo "{}" C_out\n'.format(kernel_name))
    fw.write('set_directive_array_partition -type cyclic -factor {} -dim 2 "{}" C_out\n'.format(iob, kernel_name))
    ...
    fw.write('set_directive_array_partition -type cyclic -factor {} -dim 2 "{}" buff_C_out\n'.format(iob, kernel_name))
    ...
    if bp == 'd1d2':
        ...
        fw.write('set_directive_array_partition -type cyclic -factor {} -dim 1 "{}" buff_C_out\n'.format(iob, kernel_name))
